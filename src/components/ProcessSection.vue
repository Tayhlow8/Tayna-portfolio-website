...
const copy = {
  PT: {
    ...
    title        : 'Do <em>ruído</em> à clareza.',
    steps: [
      {
        num   : '01',
        title : 'Descoberta',
  ...
  EN: {
    ...
    title        : 'From <em>noise</em> to clarity.',
    steps: [
      {
        num   : '01',
        title : 'Discovery',
  ...
  ES: {
    ...
    title        : 'Del <em>ruido</em> a la claridad.',
    steps: [
      {
        num   : '01',
  ...
  DE: {
    ...
    title        : 'Vom <em>Rauschen</em> zur Klarheit.',
    steps: [
      {
        num   : '01',
        title : 'Entdeckung',
...
@media (min-width: 640px) {
  .ps-root  { padding: var(--sp-24) 3rem; }
}

@media (min-width: 1024px) {
  .ps-root  { padding: var(--sp-24) 7rem; }
...
@media (min-width: 1400px) {
  .ps-root { padding: var(--sp-24) 10rem; }
}
</style>
